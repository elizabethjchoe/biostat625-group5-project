...
![](descriptive_analysis/logistic function.PNG){width=50%} 
\vspace{-0.6cm}
...
![](descriptive_analysis/lrresults_table-1.jpg){width=50%} 
...
![](descriptive_analysis/XGB.png){width=40%}
